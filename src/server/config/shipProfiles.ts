import type { SystemName } from '../../shared/protocol.js';
...
export const SHIP_PROFILES = {
  prototype: {
    ...
    weapons: { beamRange: 15, beamArcDegrees: 180, torpedoRange: 24, torpedoArcDegrees: 360 },
    flight: {
      maxForwardSpeed: 5.5,
      maxReverseSpeed: 2.5,
      baseTurnRateDegreesPerSecond: 18,
      enginePowerTurnBonusDegreesPerSecond: 22,
      accelerationResponse: 1.8,
      lateralThrustFraction: 0.30,
      lateralAccelerationResponse: 2.8,
  ...
  heavyCruiserExample: {
    ...
    weapons: { beamRange: 18, beamArcDegrees: 360, torpedoRange: 32, torpedoArcDegrees: 360 },
    flight: {
      maxForwardSpeed: 4.4,
      maxReverseSpeed: 1.8,
      baseTurnRateDegreesPerSecond: 12,
      enginePowerTurnBonusDegreesPerSecond: 16,
      accelerationResponse: 1.25,
      lateralThrustFraction: 0.22,
      lateralAccelerationResponse: 1.9,
